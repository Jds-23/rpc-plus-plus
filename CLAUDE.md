...
Imperative mood, lowercase after the colon, no trailing period, ≤ 72 chars. Scope is optional and comes from `src/` (`app`, `config`, `decider`, `http`, `observer`, `proxy`, `telemetry`, `upstream`) plus `tests`, `docs`, `deps`.

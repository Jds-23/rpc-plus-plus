...
Imperative mood, lowercase after the colon, no trailing period, ≤ 72 chars. Scope is optional and comes from `src/` (`rpc`, `route`, `decider`, `settings`, `telemetry`, `handler`, `healthz`, `startup`, `upstream`) plus `tests`, `docs`, `deps`.
